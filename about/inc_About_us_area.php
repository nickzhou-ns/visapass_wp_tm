<!-- inc_About_us_area start here -->
<section  page="inc_About_us_area"  class="about-area-2 pt-120 pb-80">
  <div class="container">
    <div class="row">
      <div class="col-xxl-6 col-xl-6 col-lg-6 mb-30 wow fadeInUp" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp;">
        <div class="about2-left d-flex">
          <div class="about2-left__img1 mr-10"> <img src="<?= get_my_global_variable() ?>assets/img/about-2/about2.jpg" alt=""> </div>
          <div class="about2-left__img2"> <img src="<?= get_my_global_variable() ?>assets/img/about-2/about2-1.jpg" alt="">
            <div class="about2-left__info d-flex align-items-center">
              <div class="about2-left__info__left mr-15"> <img src="<?= get_my_global_variable() ?>assets/img/about-2/seal.png" alt=""> </div>
      ...
      <div class="col-xxl-6 col-xl-6 col-lg-6 mb-30 wow fadeInUp" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInUp;">
        <div class="section_title_wrapper"> <span class="subtitle"> About visapass </span>
          <h2 class="section-title about-span mb-30"> <span>25+</span> Years of Your Trust <br>
            and Recommendation </h2>
          ...
          <div class="row mb-10">
            <div class="col-lg-6">
              <div class="about2__item d-flex  mb-20">
                <div class="about2__icon"> <i class="flaticon-fair-trade"></i> </div>
            ...
            <div class="col-lg-6">
              <div class="about2__item d-flex  mb-20">
                <div class="about2__icon"> <i class="flaticon-trophy"></i> </div>
                <div class="about2__content">
                  <h4>Awards Winner</h4>
                  <p>Most trusted & recommended by millions of students</p>
                </div>

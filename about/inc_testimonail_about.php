<div id="inc_testimonail_about_app"></div>

<script>
  createApp({
    template: `
      <section page="inc_testimonail_about" class="testimonail-area pt-110 pb-190">
        <div class="container">
          ...
          <div class="row">
            <div class="textimonail-active owl-carousel">
              <div 
                v-for="(testimonial, index) in testimonailData" 
                :key="index" 
              ...
              >
                <div class="testimonail__wrapper__info d-flex align-items-center mb-30">
                  <div class="testimonail__wrapper__info__img">
                    <img :src="'<?= get_my_global_variable() ?>'+testimonial.img" alt="">
                  </div>
                  <div class="testimonail__wrapper__info__author">
                    <h4>{{ testimonial.title }}</h4>
                    <span>{{ testimonial.title_sm }}</span>
                  </div>
  ...
  }).mount("#inc_testimonail_about_app");
</script>
